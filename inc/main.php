<?php
/**
 * Class sendmsg_Action_After_Submit
 * @see https://developers.elementor.com/custom-form-action/
 * Custom elementor form action after submit to add a subsciber to
 * sendmsg list via API
 */

 /**
  * Main SendMsg API Elements Extension Class
  *
  * The main class that initiates and runs the plugin.
  *
  * @since 1.0.0
  */
 final class SendMsg_API_Elements {
    ...
    require_once('custom-select.php');
    ...
    public function admin_notice_missing_main_plugin() {
        ...
        $message = sprintf(
            ...
            '<strong>' . esc_html__( 'Sendmsg Elements', 'sendy-elements' ) . '</strong>',
